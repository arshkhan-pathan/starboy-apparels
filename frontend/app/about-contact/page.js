    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">About & Contact</h1>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-6">
                  Founded in 2020, Venus Apparels began with a simple mission: to create fashion that empowers 
                  individuals to express their unique style while maintaining the highest standards of quality and sustainability.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  What started as a small boutique in downtown has grown into a beloved destination for fashion-forward 
                  individuals who appreciate both style and substance. Our collections blend contemporary trends with 
                  timeless elegance, ensuring every piece tells a story.
                </p>
              </div>
              ...
              <div className="aspect-square bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-purple-200 to-pink-200 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-purple-600 font-semibold text-lg">Fashion with Heart</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-xl bg-gray-50 hover:bg-purple-50 transition-colors">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Passion for Fashion</h3>
              <p className="text-gray-600">
                We pour our hearts into every design, ensuring each piece reflects our love for fashion and creativity.
              </p>
            </div>
            ...
            <div className="text-center p-8 rounded-xl bg-gray-50 hover:bg-purple-50 transition-colors">
              ...
              <p className="text-gray-600">
                We never compromise on quality, using only the finest materials and craftsmanship for every garment.
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/wishlist" className="border-2 border-white text-white px-8 py-4 rounded-lg font-medium hover:bg-white hover:text-purple-600 transition-colors text-lg">
              View Wishlist
            </Link>
          </div>
        </div>
