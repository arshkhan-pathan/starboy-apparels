        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-screen py-20">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20 mb-6">
              ...
              <span className="text-white/90 text-sm font-medium">New Collection Available</span>
            </div>
            ...
            <p className="text-xl sm:text-2xl text-gray-300 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Discover our exclusive collection of premium fashion that speaks your language. 
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start items-center mb-12">
              ...
              {!isMobile ? (
                ...
                >
                  <FiPlay className={`mr-2 transition-all ${isPlaying ? 'text-green-400' : 'text-white'}`} />
            ...
            <div className="grid grid-cols-3 gap-8 max-w-md mx-auto lg:mx-0">
              <div className="text-center group">
                <div className="text-3xl font-bold text-white mb-2 group-hover:text-purple-400 transition-colors">500+</div>
                <div className="text-sm text-gray-400 group-hover:text-gray-300 transition-colors">Unique Designs</div>
              </div>
              <div className="text-center group">
                <div className="text-3xl font-bold text-white mb-2 group-hover:text-purple-400 transition-colors">50K+</div>
            ...
            <div className="relative bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 overflow-hidden">
              ...
              {isMobile && swipeDirection && (
                <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-20">
                  <div className={`px-4 py-2 rounded-full text-sm font-medium text-white bg-white/20 backdrop-blur-md border border-white/30 transition-all duration-300 ${
                          ...
                          {product.badge && (
                            <div className="absolute top-4 left-4">
                              <span className={`px-3 py-1.5 rounded-full text-sm font-bold shadow-lg ${
                                product.badge === 'Bestseller' ? 'bg-gradient-to-r from-yellow-400 to-orange-500 text-white' :
                                product.badge === 'New' ? 'bg-gradient-to-r from-green-400 to-emerald-500 text-white' :
                                product.badge === 'Sale' ? 'bg-gradient-to-r from-red-400 to-pink-500 text-white' :
                                product.badge === 'Limited' ? 'bg-gradient-to-r from-purple-400 to-pink-500 text-white' :
