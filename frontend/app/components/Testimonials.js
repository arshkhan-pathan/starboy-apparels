  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        'The quality of these t-shirts is incredible! I love how soft and comfortable they are. The designs are unique and the fit is perfect. Highly recommend!',
      verified: true,
    },
    {
      id: 2,
      ...
      rating: 5,
      comment:
        'Fast shipping and excellent customer service. The t-shirts exceeded my expectations. Great value for money and the material feels premium.',
      verified: true,
    },
    {
      id: 3,
      ...
      rating: 5,
      comment:
        "I'm obsessed with their limited edition collection! The artwork is amazing and the fit is spot on. Will definitely be ordering more.",
      verified: true,
    },
    {
      id: 4,
      ...
      rating: 4,
      comment:
        'Great selection of styles and colors. The customer service team was very helpful with sizing questions. Quality product overall.',
      verified: true,
    },
  ];
